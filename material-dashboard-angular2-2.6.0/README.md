...
Por el contenido del README.md, estás utilizando el Material Dashboard Angular. Este dashboard es un admin gratuito basado en el diseño de Material Design de Google y construido sobre el framework Bootstrap. Fue desarrollado por Creative Tim y está diseñado para ayudar a construir productos como paneles de administración, sistemas de gestión de contenido y CRM (Customer Relationship Management).